...
<div class="modal fade" id="editBookModal_{{ $book->book_id }}" tabindex="-1" role="dialog" aria-labelledby="editBookModalLabel"
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content card" style="color: #fff;">
            <form id="editBookForm" action="{{ route('crew.book.update', $book->book_id) }}" method="POST"
                ...
                <div class="modal-header">
                    ...
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span onclick="closeModal({{ $book->book_id }})" aria-hidden="true">&times;</span>
                    </button>
                </div>
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <label for="rent_price">Rent Price (Rp)</label>
                        <input type="number" name="rent_price" id="rent_price" class="form-control" value="{{ old('rent_price', $book->rent_price) }}" required>
                    </div>
                    <div class="form-group">
